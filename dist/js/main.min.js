...
$(document).ready(function(){var e=document.querySelector("nav");window.addEventListener("scroll",function(){100<window.pageYOffset?e.classList.add("sticky"):e.classList.remove("sticky")})});