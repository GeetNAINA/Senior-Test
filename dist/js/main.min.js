...
$(document).ready(function(){$(".icon-bar").click(function(){$("body").toggleClass("showing")}),$(".icon-close").click(function(){$("body").removeClass("showing")})}),window.addEventListener("scroll",function(){document.querySelector("nav").classList.toggle("sticky",0<window.scrollY)});